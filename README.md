...
```javascript
import gapxsum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapxsum@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapxsum@v0.3.0-deno/mod.js';
```
